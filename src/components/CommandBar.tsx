...
import { GridIcon } from "../assets/index.js";
...
interface CommandBarProps {
  isOpen: boolean;
  clickFn: (isOpen: boolean) => boolean;
}
  ...
  const footerItems: NavigationItem[] = [
    {
      ...
      icon: (
        <svg
          className="tw-ml-4 h-8 w-8 text-red-300"
          viewBox="0 0 24 24"
          fill="none"
          height="1em"
          width="1em"
              ...
              {filteredItems.map((item, index) =>
                item.type === "header" ? (
                  ...
                  <>
                    ...
                    <div
                      key={index}
                      className="tw-p-2 tw-flex tw-justify-between tw-items-center tw-text-sm tw-text-gray-500">
  ...
  return (
    <>
      ...
      <button
        className={`${
          isOpen ? "tw-hidden" : ""
        } tw-fixed tw-bottom-5 tw-right-5 tw-z-10 tw-rounded-full tw-bg-blue-500 tw-text-white tw-p-2 tw-flex tw-justify-center tw-items-center`}
