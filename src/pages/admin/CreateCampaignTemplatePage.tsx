...
const supportTextSections = [
  ...
  {
    section: "What is a TechSkillnical Assessment Component?",
    message:
...
function CreateCampaignPage() {
  ...
  const generalInterviewData: GeneralInterviewInfo = {
    questionList: [
      {
        question: "Tell us about yourself and your professional background",
        keywordPositive: [{ keyword: "name", weightage: 1 }],
        keywordNegative: [{ keyword: "don't know", weightage: 5 }],
      },
      {
        question: "Why are you interested in this position?",
        keywordPositive: [
          { keyword: "mission", weightage: 0.7 },
          { keyword: "values", weightage: 0.6 },
        ],
        keywordNegative: [],
      },
      {
        ...
        keywordPositive: [
          { keyword: "problem solving", weightage: 0.8 },
          { keyword: "time management", weightage: 0.7 },
        ],
        keywordNegative: [
          { keyword: "procrastination", weightage: 0.2 },
          { keyword: "none", weightage: 0.8 },
        ],
      },
    ],
  };
  const technicalAssessmentData: TechnicalAssessmentInfo = {
    sectionList: [
      {
        ...
        questionList: [
          {
            ...
            keywordPositive: [{ keyword: "bytecode", weightage: 1 }],
            keywordNegative: [],
          },
          {
            question: "What is the difference between JDK, JRE and JVM",
            keywordPositive: [
              { keyword: "software development kit", weightage: 0.7 },
              { keyword: "virtual machine", weightage: 0.6 },
            ],
            keywordNegative: [],
          },
        ],
  ...
  const hiringManagerData: HiringManagerInterviewInfo = {
    interviewTitle: "Hiring Manager 30 Minutes Interview",
    durationMinutes: 30,
    description: "A quick chat with the team lead to assess your suitability to join the team."
  }
  const templateData: InterviewComponent[] = [
    {
      stepNumber: 0,
      name: "General Interview",
      type: "General Interview",
      interviewInfo: generalInterviewData,
    },
    {
      stepNumber: 1,
      name: "Skill Assessment 1",
      type: "Technical Assessment",
      interviewInfo: technicalAssessmentData,
    },
    {
      stepNumber: 2,
      name: "Skill Assessment 2",
      type: "Technical Assessment",
      interviewInfo: technicalAssessmentData,
    },
    {
      ...
      interviewInfo: hiringManagerData,
    },
  ];
                ...
                <Accordion.Item eventKey="">
                  ...
                  <Accordion.Body>
                    <div className="tw-w-full tw-flex tw-flex-col tw-p-2">
                      ...
                      <button
                        className="tw-bg-red-700 tw-text-white tw-rounded-lg tw-py-2 tw-mt-2"
                        onClick={handleAiGenerateQuestionButtonClick}>
        ...
        <div className="tw-h-full tw-w-full tw-relative tw-py-48 tw-px-64 tw-z-10">
          <div className="tw-h-full tw-w-full tw-relative tw-flex tw-flex-col tw-items-center tw-bg-white tw-rounded-3xl tw-z-100">
            <div className="tw-w-full tw-flex tw-justify-end tw-p-5">
              <button
                className="tw-text-black tw-w-[2rem]"
                onClick={() => setIsShowingOneClickPostingModal(false)}>
                <CrossIcon />
              </button>
            </div>
            <div
            ...
            <div className="tw-absolute tw-bottom-10 tw-flex tw-flex-col tw-justify-center">
              <button
                className="tw-bg-red-700 tw-rounded-lg tw-text-white tw-py-3 tw-px-5"
                onClick={() => navigate("/admin")}>
                One Click Job Posting
              </button>
              <span className="tw-mt-5">
                The job posting will be advertised to all the above platforms with only one click.
              </span>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="tw-h-screen tw-w-screen tw-flex tw-flex-col tw-bg-gray-100">
      ...
      <div className="main-container tw-py-10 tw-px-24">
        <div className="tw-flex tw-items-center">
          <span className="tw-text-red-700 tw-font-bold tw-text-5xl tw-mb-3">
      ...
      <div
        ...
        <div className="tw-h-4/6 tw-w-1/2 tw-px-5 tw-pt-10 tw-pb-5 tw-bg-white tw-rounded-xl tw-shadow tw-z-10 tw-overflow-auto">
          <div className="tw-w-full tw-flex tw-justify-between tw-items-center">
            <span className="tw-font-bold tw-text-2xl">Welcome to the Create Campaign Page!</span>
            <div
